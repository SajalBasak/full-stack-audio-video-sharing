...
<html>
<head>
	<title>STREAM | Uploaded videos</title>
...
<div>
	<p class="all-up">All uploaded videos are listed here</p><hr>
<?php
...
while($row=mysqli_fetch_assoc($query))
{
	...
	$name1 = $row['name'];
	$temp2 = $row['profile'];
	echo "<a class='w-a' href='watch.php?id=$id'>$name1</a><p class='us-pa'> uploaded by<p class='bold-pa'>$temp2 </p> </p><br>";
}
